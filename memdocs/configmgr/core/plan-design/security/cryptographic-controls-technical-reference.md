...
Zie [het gebruik van bepaalde cryptografische algoritmen en protocollen in Schannel. dll beperken en de prioriteit van](https://support.microsoft.com/en-us/kb/245030/) [Schannel-coderings suites bepalen](https://msdn.microsoft.com/library/windows/desktop/bb870930.aspx)voor meer informatie. Deze procedures hebben geen invloed op de functionaliteit van Configuration Manager.
