...
4. Bevestig dat u de eigenaar van het domein bent dat u in de vorige stap hebt opgegeven. 
   ...
   > [!NOTE]
   > Voor meer informatie over de verificatie van TXT-records raadpleegt u [DNS-records maken bij DNS-hostingproviders voor Microsoft 365](https://support.office.com/article/Create-DNS-records-at-any-DNS-hosting-provider-for-Office-365-7B7B075D-79F9-4E37-8A9E-FB60C1D95166).
