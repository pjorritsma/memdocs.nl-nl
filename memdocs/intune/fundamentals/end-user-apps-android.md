---
title: Hoe uw Android-gebruikers hun apps downloaden
...
---
# <a name="how-your-android-users-get-their-apps"></a>Hoe uw Android-gebruikers hun apps downloaden  
...
**Beheerde apps**: dit zijn apps die worden beheerd via beleid. Ze zijn "verpakt" door Intune of gebouwd met de Intune App SDK. These apps can be managed by Intune, and application policies can be applied to them.
