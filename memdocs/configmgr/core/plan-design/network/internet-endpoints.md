...
Als u Windows 10-apparaten inschrijft voor Microsoft Intune voor co-beheer, moet u ervoor zorgen dat deze apparaten toegang hebben tot de eind punten die vereist zijn voor intune. Zie [Network-eind punten voor Microsoft intune](/intune/intune-endpoints)voor meer informatie.

## <a name="microsoft-store-for-business"></a>Microsoft Store voor bedrijven

Als u Configuration Manager integreert met de [Microsoft Store voor bedrijven](../../../apps/deploy-use/manage-apps-from-the-windows-store-for-business.md), moet u ervoor zorgen dat het service aansluitpunt en de doel apparaten toegang hebben tot de Cloud service. Zie [Microsoft Store voor Business proxy configureren](/microsoft-store/prerequisites-microsoft-store-for-business#proxy-configuration)voor meer informatie.
...
- [Veelgestelde vragen over Delivery Optimization](/windows/deployment/update/waas-delivery-optimization#frequently-asked-questions)
