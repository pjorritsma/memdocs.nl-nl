---
title: Diagnostische en gebruiks gegevens voor 1906
titleSuffix: Configuration Manager
description: Meer informatie over de specifieke gegevens die door Configuration Manager worden verzameld op elk niveau in versie 1906.
ms.date: 07/26/2019
...
Voor Configuration Manager versie 1906 bevat dit niveau de volgende gegevens:

- ***[Bijgewerkt]*** Statistieken over Configuration Manager-console verbindingen: besturingssysteem versie, taal, SKU en architectuur, systeem geheugen, aantal logische processors, verbinding maken met site-ID, geïnstalleerde .NET-versies, console taal pakketten en geschikt verificatie niveau
...
- ***[Nieuw]*** Status en status van de beheer service

- ***[Nieuw]*** Hash van de sleutel kenmerken van de site (site-ID, SQL-Broker-ID en Exchange-sleutel van de site)
...
- ***[Nieuw]*** Aantal verzamelingen dat is gesynchroniseerd met Azure Active Directory
...
- ***[Nieuw]*** Aantal dubbele hardware-id's (MAC-adres en SMBIOS GUID) die zijn uitgesloten van PXE en client registratie

- ***[Nieuw]*** Aantal taken reeksen per type (besturingssysteem implementatie of algemene taken reeks)

- ***[Nieuw]*** Aantal pakketten met instellingen voor inhoud vooraf in cache
...
- ***[Nieuw]*** Lijst met abonnementen op software-update catalogussen van derden

- ***[Nieuw]*** Gebruik van WSUS-onderhouds instellingen
...
- ***[Nieuw]*** Cumulatieve prestatie statistieken van aanroepen naar Software Center-eind punten op het beheer punt
...
- ***[Nieuw]*** Cumulatieve statistieken voor het gebruik van Desktop Analytics

- ***[Nieuw]*** Configuratie en status van de SQL-onderhouds taak
...
- ***[Nieuw]*** Lijst met Configuration Manager-console-extensies
