...
CMPivot bevat nu Basic-ondersteuning voor de [operator log Analytics render](/azure/kusto/query/renderoperator). Deze ondersteuning omvat de volgende typen:  
