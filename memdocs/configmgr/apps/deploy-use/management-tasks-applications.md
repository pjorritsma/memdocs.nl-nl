...
##  <a name="manage-applications"></a>Toepassingen beheren  
 Vouw in de werk ruimte **software bibliotheek** het knoop punt toepassingen voor **toepassings beheer**uit  >  **Applications**, kies de toepassing die u wilt beheren en kies vervolgens een beheer taak.  
