...
| Het wachtwoord is te kort.| Stel een wachtwoord met meer tekens in of werk uw wachtwoord bij. Uw organisatie vereist dat uw wachtwoord een bepaalde lengte heeft. Wat er daadwerkelijk wordt gekozen, zal variëren. Er kan een minimale lengte van vier tekens en een maximale lengte van zestien tekens worden vereist. |
...
| Het wachtwoord moet complexe tekens bevatten. | Voorbeelden van complexe tekens zijn cijfers, hoofdletters en symbolen zoals `$`, `%` en `#`. Uw organisatie vereist een combinatie van letters, cijfers en niet-alfanumerieke tekens, zodat anderen uw wachtwoord niet eenvoudig kunnen raden.|  
...
## <a name="ios-passcode-requirements"></a>iOS-vereisten voor wachtwoordcodes

| Bericht | Problemen oplossen |
|-----------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Er is een wachtwoordcode vereist.| Stel een wachtwoordcode in. Uw organisatie vereist dat u een wachtwoordcode invoert om uw apparaat te ontgrendelen. |
| De wachtwoordcode is te eenvoudig. |  Zorg ervoor dat uw wachtwoordcode geen opeenvolgende of herhaalde cijfers bevat, zoals 1234 of 1111. |
| De wachtwoordcode is te kort. | Stel een wachtwoordcode met meer tekens in of werk uw wachtwoord bij. Uw organisatie vereist dat uw wachtwoordcode een bepaalde lengte heeft. Wat er daadwerkelijk wordt gekozen, zal variëren. Er kan een minimale lengte van vier tekens en een maximale lengte van veertien tekens worden vereist. Wanneer u uw wachtwoordcode wijzigt, is het mogelijk dat u een prompt van Apple ziet waarin u wordt gevraagd zes of meer tekens op te geven. Dit is een systeemaanbeveling van Apple. Als uw organisatie alleen een wachtwoordcode van vier of vijf tekens vereist, hoeft u geen wachtwoordcode van zes cijfers op te geven.|  
| De wachtwoordcode mag alleen cijfers bevatten. | Stel een wachtwoordcode in die alleen cijfers bevat.|
| De wachtwoordcode mag alleen alfanumerieke tekens bevatten.| Stel een wachtwoordcode in die een combinatie van cijfers en letters bevat.|
| De wachtwoordcode moet niet-alfanumerieke tekens bevatten. | Voeg speciale tekens toe, zoals `&`, `!`, `$`, `%`en `#`. Uw organisatie vereist een combinatie van letters, cijfers en niet-alfanumerieke tekens, zodat anderen uw wachtwoordcode niet eenvoudig kunnen raden.|
| De wachtwoordcode is verlopen. | Stel een nieuw wachtwoord in. Uw organisatie vereist dat u uw wachtwoord na een bepaald aantal dagen wijzigt. |
| Uw wachtwoord is te recentelijk nog gebruikt.| Kies een wachtwoordcode die u nog niet eerder hebt gebruikt. Uw organisatie vereist dat er een bepaalde hoeveelheid tijd is verstreken voordat u een wachtwoordcode opnieuw kunt gebruiken. |
|Verificatie met Touch ID of Face ID vereist. | Stel Touch ID of Face ID in. Uw organisatie vereist dat u zich verifieert met een van deze methoden voordat u Automatisch doorvoeren gebruikt om wachtwoord- of creditcardgegevens in te vullen. | 
