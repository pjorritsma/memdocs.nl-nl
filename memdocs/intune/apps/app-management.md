...
| Optionele installatie op apparaten via de bedrijfsportal (beschikbare installatie) | Ja <sup>3</sup> | Ja | Ja | Ja |
| Installatiesnelkoppeling naar een app op internet (webkoppeling) | Ja <sup>4</sup> | Ja | Ja | Ja |
| Interne apps (Line-Of-Business-apps) | Ja | Ja | Ja | Ja |
