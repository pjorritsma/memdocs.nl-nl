...
> [!TIP]
> Standaard biedt geen `ConfigMgrInstallation.adm` ondersteuning voor teken reeksen die groter zijn dan 255 tekens. Deze configuratie kan van invloed zijn op het toevoegen van meerdere para meters of para meters met lange waarden, zoals CCMCERTISSUERS.<!-- SCCMDocs#1648 -->
>
